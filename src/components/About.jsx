function About() {
    return (
        <section className="about-section scroll-reveal scroll-reveal-bottom" id="about">
            ...
            <div className="about-main">
                ...
                <div className="cta-wrapper pt-6 inline-block">
                    <a href="/afreen-shaikh-resume.pdf" target="_blank" rel="noopener noreferrer" className="link">
                        View Full Resume
